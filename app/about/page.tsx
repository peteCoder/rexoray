        ...
        <div className="container mx-auto text-left max-w-4xl">
          ...
          <RevealOnScroll>
            <p className="text-lg leading-relaxed text-gray-300 dark:text-gray-400">
              We are a dynamic, diversified Nigerian company delivering
              excellence in general contracting, petroleum marketing,
              manufacturing, agriculture, transportation, and event management.
              With a relentless drive for innovation, we are committed to
          ...
          <div>
            ...
            <RevealOnScroll>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4 text-lg">
                Incorporated in 2024, <strong>REXORAY ACE LTD</strong> was
                founded on a vision to provide superior solutions across
                multiple sectors while maintaining a people-first approach. From
                humble beginnings, we’ve grown into a trusted brand known for
                delivering high-quality projects and services that exceed
                expectations.
              </p>
            </RevealOnScroll>
            <RevealOnScroll>
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-900 rounded-lg shadow hover:shadow-md transition">
                ...
                <RevealOnScroll>
                  <p className="text-gray-700 dark:text-gray-300">
                    To provide high-quality products and services that
                    consistently meet the needs of our clients while upholding
                    integrity, innovation, and excellence in all aspects of our
                    operations.
                  </p>
                </RevealOnScroll>
              </div>
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-900 rounded-lg shadow hover:shadow-md transition">
                ...
                <RevealOnScroll>
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    recognized for delivering outstanding solutions and
                    fostering lasting relationships built on trust.
                  </p>
                </RevealOnScroll>
              </div>
            </RevealOnScroll>
